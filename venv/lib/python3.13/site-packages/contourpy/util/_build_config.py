...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/workspaces/tesseract_algorithm/venv/bin/python",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/tmp/pip-install-gzzlr8_l/contourpy_ac18e5d0c6ff4acdb940606f173a5bd6/.mesonpy-wdunjfl9/lib/contourpy/util",
        source_dir=r"/tmp/pip-install-gzzlr8_l/contourpy_ac18e5d0c6ff4acdb940606f173a5bd6/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/tmp/pip-install-gzzlr8_l/contourpy_ac18e5d0c6ff4acdb940606f173a5bd6/.mesonpy-wdunjfl9/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
